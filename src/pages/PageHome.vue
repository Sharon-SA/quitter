    ...
    <q-scroll-area class="absolute fullscreen">
      ...
      <q-list separator>
        ...
        <q-item v-for="qweet in qweets" :key="qweet.date" class="q-py-md">
          ...
          <q-item-section>
            <q-item-label><strong> Sharon Sotunde </strong> </q-item-label>
  ...
  data() {
    return {
      ...
      qweets: [
        ...
        {
          content:
            "Aerodynamically the bumblebee shouldnt be able to fly but the bumblebee doesnt know that so it goes on flying anyway",
          date: 1635628100512,
        },
      ],
    };
